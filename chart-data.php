...
$pie->set_values(array(new pie_value($assassins, "Assassins"),new pie_value($rangers, "Rangers"),new pie_value($chanters, "Chanters"),new pie_value($clerics, "Clerics"),new pie_value($gladiators, "Gladiators"),new pie_value($templars, "Templars"),new pie_value($sorcerers, "Sorcerers"),new pie_value($spiritmasters, "Spiritmasters")));
